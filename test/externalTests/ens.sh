...
function ens_test
{
    ...
    local settings_presets=(
        ...
        #ir-no-optimize           # "YulException: Variable var__945 is 1 slot(s) too deep inside the stack."
        #ir-optimize-evm-only     # "YulException: Variable var__945 is 1 slot(s) too deep inside the stack."
        #ir-optimize-evm+yul      # "YulException: Variable _5 is 1 too deep in the stack [ _5 usr$i usr$h _7 usr$scratch usr$k usr$f _4 usr$len usr$j_2 RET _2 _1 var_data_mpos usr$totallen usr$x _12 ]"
