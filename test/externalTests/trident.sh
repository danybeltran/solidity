...
function trident_test
{
    ...
    local settings_presets=(
        ...
        #ir-no-optimize            # YulException: Variable var_amount_165 is 9 slot(s) too deep inside the stack.
        #ir-optimize-evm-only      # YulException: Variable var_amount_165 is 9 slot(s) too deep inside the stack.
        #ir-optimize-evm+yul       # YulException: Cannot swap Variable var_nearestTick with Variable _4: too deep in the stack by 4 slots
        legacy-no-optimize
