...
from externalTests.parse_eth_gas_report import ContractGasReport, GasReport, MethodGasReport, parse_report
from externalTests.parse_eth_gas_report import ReportParsingError, ReportValidationError
...
class TestEthGasReport(unittest.TestCase):
    ...
    def test_parse_report_should_fail_if_deployment_row_appears_under_methods_header(self):
        ...
        """).strip('\n')
        expected_message = dedent("""
            Parsing error on line 2: invalid literal for int() with base 10: '-'
            | ERC1155Token | - | - | 525869 | 5 | - |
        """).strip('\n')
